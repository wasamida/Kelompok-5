...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="team-box text-center to-animate-2">
              <div class="user"><img class="img-reponsive" src="{{asset('assets/images/person4.jpg')}}" alt="Roger Garfield"></div>
          ...
          <div class="col-md-4">
            <div class="team-box text-center to-animate-2">
              <div class="user"><img class="img-reponsive" src="{{asset('assets/images/person3.jpg')}}" alt="Roger Garfield"></div>
        ...
        <div class="row">
           <div class="col-md-2 col-sm-3 col-xs-6 col-sm-offset-0 col-md-offset-1">
            <div class="partner-logo to-animate-2">
              <img src="{{asset('assets/images/logo1.png')}}" alt="Partners" class="img-responsive">
            </div>
           </div>
            <div class="col-md-2 col-sm-3 col-xs-6">
              <div class="partner-logo to-animate-2">
                <img src="{{asset('assets/images/logo2.png')}}" alt="Partners" class="img-responsive">
            </div>
            </div>
            <div class="col-md-2 col-sm-3 col-xs-6">
              <div class="partner-logo to-animate-2">
  ...
  <!-- Google Map -->
  <script src="{{asset('assets/https://maps.googleapis.com/maps/api/js?key=AIzaSyCefOgb1ZWqYtj7raVSmN4PL2WkTrc-KyA&sensor=false')}}"></script>
